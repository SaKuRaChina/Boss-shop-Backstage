	...
	export default{
		...
		methods:{
			initPage(){
				...
				$.ajax({
					type:'post',
					url:that.Global.router + '/product/editVideo',
					...
					success(res){
						...
						if(res.code === "0000"){
							...
							that.playVideo(that.pageObj.url,that.pageObj.surfaceUrl + '!default')
			...
			savePage(){
				...
				//sendObj.videoUrlId = that.pageObj.videoUrlId
				...
				$.ajax({
					type:'post',
					url:that.Global.router + '/product/updateVideo',
					data:sendObj,
					xhrFields:{withCredentials: true},
					success(res){
						console.log(res)
			...
			selfUploadVideo(files){
				...
				var resultMsg = qcVideo.ugcUploader.start({
					...
					finish: function(res){
						...
						that.pageObj.videoUrlId = res.fileId
						that.pageObj.videoUrl = res.videoUrl;
						that.playVideo(that.pageObj.videoUrl,that.pageObj.surfaceUrl + '!default')
